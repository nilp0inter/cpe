...
version = cpe.get_release()

# The full version, including alpha/beta/rc tags.
release = cpe.get_version()
...
latex_documents = [
    (SOURCE_START_FILE, 'CPE.tex', html_title, AUTHORS, 'manual'),
]
...
man_pages = [
    (SOURCE_START_FILE, PROJECT_NAME, html_title, [AUTHORS], 1)
]
...
texinfo_documents = [
    (SOURCE_START_FILE, PROJECT_NAME, html_title, AUTHORS, PROJECT_NAME,
